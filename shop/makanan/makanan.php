					...
					<div class="col-md-4 mb-3" style="width: 20rem"> -->
						<form> 
							<!-- <form action="kirim.php" method="post" target="_blank"> -->
								...
								<!-- <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#PratinjauBarang" >
									Pratinjau Barang
								</button> -->
								<a class="btn btn-success mb-2  px-4" href="tampil_makanan.php?id=<?php echo $row["id_barang"]?>" role="button">Lihat</a>
								<a class="btn btn-primary mb-2 px-4" href="kirim.php?id=<?php echo $row["id_barang"]?>" role="button">Beli</a>

								<!-- <button class="btn btn-primary mb-2 px-4" type="submit" name="submit">Beli</button> -->
