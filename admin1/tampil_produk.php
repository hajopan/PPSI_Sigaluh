...
$ambil=query("SELECT*FROM tb_barang INNER JOIN kategori ON kategori.id_kategori = tb_barang.id_kategori ORDER BY id_barang DESC");
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="card">
          <div class="card-body">
            <center>
              <h3>
               Produk<strong> SI GALUH</strong> <br>
              </h3>
            </center>
...
<a class="btn btn-primary" href="../input_barang/index.php" role="button">Tambah Data</a>
<?php $i=1; ?>
